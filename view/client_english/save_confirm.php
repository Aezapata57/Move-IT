...
$message = "<b>YOUR ORDER HAS BEEN SAVED SUCCESSFULLY, DON'T FORGET TO VERIFY USING YOUR EMAIL SO THAT A DRIVER CAN BE ASSIGNED TO YOU</b><br>";
$message .= "Base rate: $" . number_format($base, 2) . " COP<br>";
$message .= "Details of items and their prices:<br>";
...
$message .= "Cost for distance ($distancia km a $precioPorKilometro COP/km): $" . number_format($subtotalDistancia, 2) . " COP<br>";

$costoTotal += $subtotalDistancia;
$message .= "Total cost: $" . number_format($costoTotal, 2) . " COP<br>";

$confirmbutton = "http://localhost/move-it/view/client_english/succes_confirm.php";
        ...
        <body>
            <div class='container-fluid'>
                <div class='container'>
                    ...
                    <p class='message'>
                        Your service has been successfully submitted, you can verify your items and the total value here:<br>
                        $message<br>
                    </p>
                    <a href='$confirmbutton'>Confirm order</a>
                    <p class='message'>
                        Thank you for using our services, we will be attentive to your service!
                    </p>
                </div>
            </div>
        </body>
