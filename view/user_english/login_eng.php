                ...
                <div class="container-1">
                    ...
                    <div class="container-2">
                        <h4 class="pb-1 mb-3 slogan">NOS MOVEMOS POR TI</h4>
                            <form action="session_eng.php" method="POST" autocomplete="off">
                                ...
                                <div class="text-center pt-1 mb-2 pb-1">
                                    <button class="iniciar-sesion mb-3" type="submit">Login</button>
                                    <a class="text-muted password" href="recover_eng.php">¿Forgot your password?</a>
                                </div>
                
                                <div class="d-flex align-items-center justify-content-center pb-4">
                                    <p class="mb-0 me-2 new-register-1">¿You do not have an account?</p>
                                    <a href="signup_eng.php" class="new-register-2">Register</a>
                                </div>
                            </form>
