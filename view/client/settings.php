<?php
    require_once("../head/header_client_settings.php");
                ...
                <div class="card-body p-md-5 mx-md-4">
                    <div class="container-1">
                        <div class="row home text-center" href="../../index.php">
                            <div class="logo-text-settings mb-3">AJUSTES</div>
                        </div>
                        <div class="container-2">
                            <div class="row input-setting">
                                <div class="col text-settings mt-2">Eliminar cuenta</div>
                                <div class="col">
                                    <button type="button" class="btn btn-danger col" data-bs-toggle="modal" data-bs-target="#staticBackdropDelete">Eliminar</button>
                                </div>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header text-modal">
                                                <h1 class="modal-title fs-5" id="staticBackdropDelete">Alerta</h1>
                                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                            </div>
                                            <div class="modal-body text-modal">
                                                ¿Deseas eliminar tu cuenta de nuestra pagina?
                                            </div>
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-secondary text-modal" data-bs-dismiss="modal">Cerrar</button>
                                                <a type="button" class="btn btn-danger text-modal" href="delete_user.php">Eliminar</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
