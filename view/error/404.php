...
<body>
    <div class='container-fluid'>
        <div class='container'>
            <div class='row' style='margin: 0 auto;display: fixed;width: 350px;align-items: center;text-align: center;'>
            ...
            <p class='message'>
                ERROR 404, the page you are trying to access is not currently found.
            </p>
            <p class='message'>
                To return to the main page click here: <a href="/move-it/index.php">Home</a>
            </p>
        </div>
    </div>
</body>
